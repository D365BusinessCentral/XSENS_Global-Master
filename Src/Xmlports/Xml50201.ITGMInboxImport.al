xmlport 50201 "IT GM Inbox Import"
{
    Caption = 'IT GM Inbox Import';
    //Direction = Import;
    Encoding = UTF8;
    FormatEvaluate = Xml;
    ...
    schema
    {
        ...
        {
            tableelement(ITGMTransactions; "IT GM Inbox Transactions")
            {
                ...
                {
                    MinOccurs = Zero;
                    tableelement("GLAccount"; "IT GM Inbox G/L Account")
                    {
                        MinOccurs = Zero;
                        LinkTable = ITGMTransactions;
                        LinkFields = "No." = field("Document No."), "Source Type" = field("Source Type"), "Inbox Entry No." = field("Entry No.");
                        ...
                        {
                            MinOccurs = Zero;
                            tableelement(GLDimension; "IT GM Inbox Default Dimensions")
                            {
                                LinkTable = GLAccount;
                                MinOccurs = Zero;
                                LinkFields = "Table ID" = const(15), "No." = field("No."), "Inbox Entry No." = field("Inbox Entry No.");
                                ...
                                begin
                                    GLDimension."Inbox Entry No." := GLAccount."Inbox Entry No.";
                                end;
                            }
                        }
                        trigger OnBeforeInsertRecord()
                        var
                            myInt: Integer;
                        begin
                            GLAccount."Inbox Entry No." := ITGMTransactions."Entry No.";
                        end;
                    }
                }
                textelement(GMItems)
                {
                    MinOccurs = Zero;
                    tableelement("Items"; "IT GM Inbox Items")
                    {
                        LinkTable = ITGMTransactions;
                        MinOccurs = Zero;
                        LinkFields = "No." = field("Document No."), "Source Type" = field("Source Type"), "Inbox Entry No." = field("Entry No.");
                        ...
                        {
                            MinOccurs = Zero;
                            tableelement(ItemDimension; "IT GM Inbox Default Dimensions")
                            {
                                LinkTable = Items;
                                MinOccurs = Zero;
                                LinkFields = "Table ID" = const(27), "No." = field("No."), "Inbox Entry No." = field("Inbox Entry No.");
                                ...
                                trigger OnBeforeInsertRecord()
                                begin
                                    ItemDimension."Inbox Entry No." := Items."Inbox Entry No.";
                                end;
                            }
                        }
                        trigger OnBeforeInsertRecord()
                        begin
                            Items."Inbox Entry No." := ITGMTransactions."Entry No.";
                        end;
                    }
                }
                ...
                {
                    MinOccurs = Zero;
                    tableelement("Dimensions"; "IT GM Inbox Dimension Value")
                    {
                        LinkTable = ITGMTransactions;
                        MinOccurs = Zero;
                        LinkFields = "Code" = field("Document No."), "Dimension Code" = field("Primary Key 2"), "Source Type" = field("Source Type"), "Inbox Entry No." = field("Entry No.");
                        ...
                        trigger OnBeforeInsertRecord()
                        begin
                            Dimensions."Inbox Entry No." := ITGMTransactions."Entry No.";
                        end;
                    }
                }
            }
