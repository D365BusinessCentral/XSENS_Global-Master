page 50219 "IT GM Inbox Handled Items"
{

    Caption = 'GM Inbox Handled Items';
    PageType = Card;
    SourceTable = "IT GM Inbox Handled Items";
    Editable = false;
    layout
    {
        area(content)
    ...
    actions
    {
        area(Processing)
        {
            action("Dimensions")
            {
                ApplicationArea = All;
                image = Dimensions;
                RunObject = page "IT GM Inbox Handl. Def. Dimen.";
                RunPageLink = "Table ID" = const(27), "No." = field("No."), "Inbox Entry No." = field("Inbox Entry No.");
                trigger OnAction()
                begin
