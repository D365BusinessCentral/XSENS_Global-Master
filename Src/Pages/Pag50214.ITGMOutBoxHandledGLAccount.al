page 50214 "IT GM Outbox Handled G/L Acc."
{

    Caption = 'GM Outbox Handled G/L Account';
    PageType = Card;
    SourceTable = "IT GM OutBox Handled G/L Acc.";
    Editable = false;
    layout
    {
        area(content)
    ...
    actions
    {
        area(Processing)
        {
            action("Dimensions")
            {
                ...
                RunPageLink = "Table ID" = const(15), "No." = field("No."), "Outbox Entry No." = field("Outbox Entry No.");
                trigger OnAction()
                begin
