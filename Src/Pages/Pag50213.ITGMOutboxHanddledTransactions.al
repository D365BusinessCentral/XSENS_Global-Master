page 50213 "IT GM Outbox Handled Trans."
{

    ApplicationArea = All;
    Caption = 'GM Outbox Handled Transactions';
    PageType = Worksheet;
    SourceTable = "IT GM Outbox Handled Trans.";
    ...
    actions
    {
        area(Navigation)
        {
            action("Details")
            {
                ...
                trigger OnAction()
                var
                    RecGL: Record "IT GM Outbox Handled G/L Acc.";
                    RecItem: Record "IT GM Outbox Handled Items";
                    RecDimension: Record "IT GM Outbox Handled Dimension";
                begin
                    case Rec."Source Type" of
                        Rec."Source Type"::"G/L Account":
                            begin
                                ...
                                Page.RunModal(Page::"IT GM Outbox Handled G/L Acc.", RecGL);
                            end;
                        ...
                        Rec."Source Type"::Item:
                            begin
                                ...
                                Page.RunModal(Page::"IT GM Outbox Handled Items", RecItem);
                            end;
                        Rec."Source Type"::"Dimension Value":
                            begin
                                ...
                                Page.RunModal(Page::"IT GM Outbox Handled Dimension", RecDimension);
                            end;
                    end;
                end;
            }
