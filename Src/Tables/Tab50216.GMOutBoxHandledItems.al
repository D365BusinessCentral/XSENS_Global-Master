table 50216 "IT GM Outbox Handled Items"
{
    ...
    fields
    {
        ...
        field(50205; "Source Type"; Enum "IT Data Replication Fn")//Custom
        {
            Caption = 'Source Type';
            DataClassification = ToBeClassified;
        }
        field(50206; "Entry No."; Integer)//Custom
        {
            DataClassification = ToBeClassified;
            AutoIncrement = true;
        }
        field(50207; "Outbox Entry No."; Integer)
        {
            DataClassification = ToBeClassified;
        }
