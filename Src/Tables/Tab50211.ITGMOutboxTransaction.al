table 50211 "IT GM Outbox Transactions"
{
    ...
    trigger OnDelete()
    var
        OutboxGL: Record "IT GM Outbox G/L Account";
        OutboxItem: Record "IT GM Outbox Items";
        OutboxDefaultDimension: Record "IT GM Outbox Default Dimens.";
        OutboxDimensionValue: Record "IT GM Outbox Dimension Value";
    begin
