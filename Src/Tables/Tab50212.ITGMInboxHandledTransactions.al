table 50212 "IT GM Inbox Handled Trans."
{
    Caption = 'GM Inbox Handled Transactions';
    ...
    trigger OnDelete()
    var
        InboxGL: Record "IT GM Inbox Handled G/L Acc.";
        InboxItem: Record "IT GM Inbox Handled Items";
        InboxDefaultDimension: Record "IT GM Inbox Handl Def. Dimens.";
        InboxDimensionValue: Record "IT GM Inbox Handled Dimension";
    begin
